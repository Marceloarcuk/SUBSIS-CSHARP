...
namespace DITI_LIVROM
{
    ...
    public static class cJovens
    {
        ...
        public static Color _PIF() { return Color.Green; }
        public static Color _Preventivo() { return Color.Gold; }
        public static Color _PrepSaida() { return Color.Black; }
        ...
        // JOVENS ORDENAÇÃO
        //---------------------------------------------------------
        private static string _vJovensOrderBy = "quarto";
        public static string ViewOrderBy
        {
            get { return _vJovensOrderBy; }
            set { _vJovensOrderBy = value; }
        }
        //---------------------------------------------------------
                ...
                foreach (Form _Forms in Application.OpenForms)
                    foreach (System.Windows.Forms.Control _Controles in _Forms.Controls)
                        if (_Controles.Name == "pnlJovens")
                            foreach (Control _Bor in _Controles.Controls)
                                if (_Bor.Name == "Bor" + scodigo)
                                    foreach (Control c in _Bor.Controls)
                                    {
        ...
        public static void f_dados_jovem(string nJov)
        {
            try
            {
                ...
                cJovemSelect.Alerta_Status = "";
                cJovemSelect.Alerta_Data = "0";
                cJovemSelect.Alerta_Dia = "0";
                ...
                if (Globais.MYSQL)
                {
                    vSQL = "DATE_FORMAT(tb_unidade_interno.medida_disc_data_interno, '%d/%m/%Y') AS data_medida";
                    vSQL1 = "DATE_FORMAT(tb_unidade_interno.alerta_data_interno, '%d/%m/%Y') AS data_medida_alerta";
                }

                //ACCESS
                else
                {
                    vSQL = "Format([medida_disc_data_interno],'dd/mm/yyyy') AS data_medida";
                    vSQL1 = "Format([alerta_data_interno],'dd/mm/yyyy') AS data_medida_alerta";
                }
                 ...
                 RecordSet = Consulta.Consultar("SELECT tb_unidade_interno.id_unidade, tb_unidade_interno.id_modulo, tb_interno.id_interno, " +
                                                  ...
                                                  "tb_unidade_interno.status_interno, " + vSQL + ", tb_unidade_interno.medida_disc_dia_interno, " +
                                                  "tb_unidade_interno.alerta_status_interno, " + vSQL1 + ", tb_unidade_interno.alerta_dia_interno " +
                ...
                foreach (DataRow pRow in RecordSet.Tables[0].Rows)
                {
                    ...
                    cJovemSelect.Foto = Globais.ByteArrayToImage((Byte[])RecordSet.Tables[0].Rows[0]["foto"]);
                    ...
                    cJovemSelect.Alerta_Status = pRow.Field<string>("alerta_status_interno");
                    cJovemSelect.Alerta_Data = pRow.Field<string>("data_medida_alerta");
                    cJovemSelect.Alerta_Dia = pRow.Field<string>("alerta_dia_interno");
        ...
        //---------------------------------------------------------
        public static int CalcularDiasRestantes(string vDTOcorrencia, string vNDias)
        {
            int vResultado = 0;
            try
            {
    ...
    public static class cJovemSelect
    {
        ...
        //---------------------------------------------------------
        private static string _vAStatus = "0";
        public static string Alerta_Status
        {
            get { return _vAStatus; }
            set { _vAStatus = value; }
        }
        //---------------------------------------------------------
        private static string _vAData = "0";
        public static string Alerta_Data
        {
            get { return _vAData; }
            set { _vAData = value; }
        }
        //---------------------------------------------------------
        private static string _vADia = "0";
        public static string Alerta_Dia
        {
            get { return _vADia; }
            set { _vADia = value; }
        }
        ...
        {
            int vResultado = 0;
            try { vResultado = cJovens.CalcularDiasRestantes(cJovemSelect.MedidaDisciplinar_Data, cJovemSelect.MedidaDisciplinar_Dia); }
            catch { vResultado = 0; }
            return vResultado;
        }
        public static int AlertaRestante()
        {
            int vResultado = 0;
            try { vResultado = cJovens.CalcularDiasRestantes(cJovemSelect.Alerta_Data, cJovemSelect.Alerta_Dia); }
            catch { vResultado = 0; }
            return vResultado;
        }
    }
