...
namespace DITI_LIVROM
{
    public partial class frm_main : Form
    {
        ...
        //---------------------------------------------------------
        private void f_carregar_panel_jovens()
        {
            //-----------------------------
            //INICIALIZAR JOVENS
            //-----------------------------
            ...
            foreach (DataRow pRow in vRecordSet.Tables[0].Rows)
            {
                ...
                pics[iCont].Image = cJovens.f_foto_jovem((Byte[])vRecordSet.Tables[0].Rows[iCont]["foto"]);
                ...
                //CRIAR CHECK BOX
                if ((cJovemSelect.MedidaDisciplinarRestante() > 0) || (vTemIcon > -1))
                {
        ...
        //---------------------------------------------------------
        private void btn_view_jovens_Click(object sender, EventArgs e)
        {
        ...
        //---------------------------------------------------------
        private void btn_check_jovens_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        //---------------------------------------------------------
        private void btn_view_servidor_Click(object sender, EventArgs e)
        {
        ...
        private void btnRegistraAcao_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                    if (frm_registra_livro_entrada_jovem.ShowDialog(this) == DialogResult.OK)
                    {
                        ...
                        if ((iAcaoSelecionada == 18) || (iAcaoSelecionada == 20)) // <> (iAcaoSelecionada == 23)
                        {
                            ...
                            f_carregar_panel_jovens(); //frm_main_Load(sender, e);
                            Tamanho_Fotos_Jovem(Globais.Tamanho);
                            Redimensionar_Fotos_Jovem(Globais.Tamanho);
            ...
            else if (v_p_form == "movim_servidor_ent")
            {
                ...
                //ABRE O FORM REGISTRA NO LIVRO
                //---------------------------------------------------------
                #region CarregaForm_frm_registra_livro_mov_servidor
                //---------------------------------------------------------
                try
                {
                    //--------------------------------------------------
                ...
                //---------------------------------------------------------
                #endregion CarregaForm_frm_registra_livro_mov_servidor
                //---------------------------------------------------------
                #region CarregaForm_entrada_servidor_AcoesResposta
                //---------------------------------------------------------
                try
                {
                    int i = -1;
                ...
                //---------------------------------------------------------
                #endregion CarregaForm_entrada_servidor_AcoesResposta
                //---------------------------------------------------------
            ...
            //------------------------------------------------------------------------------
            #region FORM_transf_plantao

            else if (v_p_form == "transf_plantao")
            {
                ...
                try
                {
                    //--------------------------------------------------
                    //INDICES E DATAS DO SYSTEMA
                    frm_tranferencia_plantao.eAcao.Text = v_id_acao.ToString();
                    ...
                    //--------------------------------------------------
                    //FRASE DO LIVRO
                    //frm_tranferencia_plantao.eFrase.Text = sFrase;
                    //--------------------------------------------------
                    //DESCRIÇÃO DO RETORNO
                    frm_tranferencia_plantao.eRetorno.Text = vRetorno;
                    //--------------------------------------------------
                    //LISTVIEW SERVIDORES
                    ListViewItem item1, item2;
                    int iIndice = 0;
                    frm_tranferencia_plantao.eServidores.Items.Clear();
                    try
                    {
                        frm_tranferencia_plantao.eServidores.Columns[0].Text = "Servidores envolvidos: 0";
                        foreach (string sCadaServidorSelecionado in ArrayServidoresSelecionados_Nome)
                        {
                            item1 = new ListViewItem(new[] { sCadaServidorSelecionado,
                                                 ArrayServidoresSelecionados_Codigo[iIndice] });
                            item1.ImageIndex = 0;
                            frm_tranferencia_plantao.eServidores.Items.Add(item1);
                            iIndice++;
                        }
                        frm_tranferencia_plantao.eServidores.Columns[0].Text = "Servidores envolvidos: " + frm_tranferencia_plantao.eServidores.Items.Count.ToString();
                    ...
                    try
                    {
                        frm_tranferencia_plantao.eServidores.Columns[0].Text = "Jovens envolvidos: 0";
                        foreach (string sCadaJovemSelecionado in ArrayJovensSelecionados_Nome)
                        {
                            item1 = new ListViewItem(new[] { sCadaJovemSelecionado, ArrayJovensSelecionados_Codigo[iIndice] });
                            item1.ImageIndex = 0;
                        ...
                        frm_tranferencia_plantao.eServidores.Columns[0].Text = "Jovens envolvidos: " + frm_tranferencia_plantao.eServidores.Items.Count.ToString();
                        //}
                    }
                    catch { }
                }
                ...
                //int i = -1;
                //Int32.TryParse(frm_tranferencia_plantao.eAcao.Text, out i);
                if (frm_tranferencia_plantao.ShowDialog(this) == DialogResult.OK)
                {
                    MessageBox.Show("TRANFERENCIA DE PLANTÃO");
                }
            }

            #endregion FORM_transf_plantao
            //------------------------------------------------------------------------------
